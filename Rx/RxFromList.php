                    ...
                    <tr>
                        <table cellpadding="15px" cellspacing="15px" width="100%" >
                            ...
                            <form action="updateRX.php">
                                ...
                                <tr>
                                    <td>
                                        Note:<br/> <textarea name="note" rows="5" cols="50" ><?php echo $RxInfo[5]?></textarea>
                                    </td>
                                    <td>
                                        Provider Note:<br/> <textarea name="ProviderNote" rows="5" cols="50" ><?php echo $RxInfo[33]?></textarea>
                                    </td>
                                <tr>
                                    <td colspan="2">
