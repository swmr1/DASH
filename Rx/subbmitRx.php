...
$query = "INSERT INTO Referrals.Rx(PatientID, Status, ProviderID, Note, Authorization, presc1, mg1, quan1, dir1, dir21, presc2, mg2, quan2, dir2, dir22, presc3, mg3, quan3, dir3, dir23, presc4, mg4, quan4, dir4, dir24, presc5, mg5, quan5, dir5, dir25, Reason, ProviderNote, LastUpdatedBy) VALUES
 ('" . $_GET['patientID'] . "', '" . $_GET['status'] . "', '" . $_GET['provider'] . "', '" . str_replace("'", "\'",$_GET['note']) . "', '" . $_GET['authorization'] . "', '" .
    ...
    str_replace("'", "\'",$_GET['prescription5']) . "', '" . str_replace("'", "\'",$_GET['mg5']) . "', '" . str_replace("'", "\'",$_GET['Quantity5']) . "', '" . str_replace("'", "\'",$_GET['Dir5']) . "', '" . str_replace("'", "\'",$_GET['Dir25']) ."', '" . str_replace("'", "\'",$_GET['Reason']) ."', '" . str_replace("'", "\'",$_GET['ProviderNote']) .
    "', '" . $update . "')";
...
$audit = new AuditLog;
$audit->SetChange($_SESSION['name'] . " Added new RX for " . $_GET['patientID']);
