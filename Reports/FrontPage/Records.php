...
<table id="All" width="100%">
    ...
    <tr>
        ...
        <th onclick="sortTable(4)" width="16%">Requesting Party</th>
        <th onclick="sortTable(5)" width="10%">Check Required</th>
        <th onclick="sortTable(6)" width="10%">Last Provider</th>
        <th onclick="sortTable(7)" width="8%">Last MD</th>
        <th onclick="sortTable(8)" width="14%">Out of County</th>
    </tr>
    <?php
    $query = $_GET['query'];
