...
switch ($row[2]){
    ...
    case 1:
        ...
        $providerList .= '<option value="6">VA</option>';
        $providerList .= '</select>';
        break;
    ...
    case 6:
        ...
        $providerList .= '<option value="4">SSI</option>';
        $providerList .= '<option value="5">Life / Health Insurance</option>';
        $providerList .= '<option selected="selected" value="6">VA</option>';
        $providerList .= '</select>';
        break;
                            ...
                            <form action="updateRecordRequest.php">
                                ...
                                <tr>
                                    <td>
                                        ...
                                        echo $occ;
                                        if ($ooc == 1) {
                                            echo "Out of County: <input type=\"checkbox\" name=\"outOfCounty\" checked=''\"true\">";
                                        } else {

                                            echo "Out of County: <input type=\"checkbox\" name=\"outOfCounty\">";
                                        }
